...
/**
 * @title high-panaranoia
 * @fork stagas/paranoia
 * @artist jahpd
 * @desc psychadelic putzputz
 */
...
export function dsp(t) {
  ...
  if ( (t+1/8*2) % 1 === 0 ) lead.play('guitar', 1.8, 4.5);
  if ( (t/8+2/4) % 1 === 0 ) lead.play('guitar', 2.8, [7,14][(t/8)%2|0]);
  if ( (t/2+3/4) % 1 === 0 ) lead.play('guitar', 3.75, 4.5);

  out += lead.mix() * 1.5 * envelope(t + 5/4, 1/8, 20, [1,50][t%2|0]);
